...
import { Eye, EyeOff, Mail, Lock, ChefHat, ArrowRight, Sparkles, Utensils, Clock, Users } from 'lucide-react';
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 text-white">
          <div className="mb-8">
            ...
            <p className="text-xl text-white/90 leading-relaxed">
              Join thousands of food lovers and unlock a world of culinary creativity. 
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-white/90">Personalized recipe recommendations</span>
            </div>
            <div className="flex items-center space-x-3">
              <div className="bg-white/20 backdrop-blur-sm rounded-full p-2">
                <Sparkles className="h-5 w-5 text-white" />
              </div>
              <span className="text-white/90">Create and share your own recipes</span>
            </div>
            <div className="flex items-center space-x-3">
              <div className="bg-white/20 backdrop-blur-sm rounded-full p-2">
                <Sparkles className="h-5 w-5 text-white" />
              </div>
              <span className="text-white/90">Meal planning and shopping lists</span>
            </div>
          </div>
        </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl p-8 border border-white/20">
            <div className="text-center mb-8">
              ...
              <p className="text-secondary-600">Sign in to continue your culinary journey</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  <Mail className="absolute left-4 top-1/2 transform -translate-y-1/2 h-5 w-5 text-secondary-400 group-focus-within:text-primary-500 transition-colors" />
                  <input
                    type="email"
                    id="email"
                    name="email"
                    ...
                    className="w-full pl-12 pr-4 py-4 bg-white/50 backdrop-blur-sm border border-secondary-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all duration-200 placeholder-secondary-400"
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  <Lock className="absolute left-4 top-1/2 transform -translate-y-1/2 h-5 w-5 text-secondary-400 group-focus-within:text-primary-500 transition-colors" />
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full pl-12 pr-12 py-4 bg-white/50 backdrop-blur-sm border border-secondary-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all duration-200 placeholder-secondary-400"
